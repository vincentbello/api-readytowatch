...
class DatabaseObject {
	...
	private static function instantiate($record) {
		...
		$object = new static; // new instance of called class (which inherits DatabaseObject)
	...
	public function has_attribute($attr) {
		// get_object_vars returns an associative array with all attributes (incl. private ones) as the keys and 
		// their current values as the value
